...
const URL_TO_CONFIG_MAP: Record<string, { section: string; module: string }> = {
  ...
  '/midjourney': { section: 'console', module: 'midjourney' },
  '/wallet': { section: 'personal', module: 'topup' },
  '/profile': { section: 'personal', module: 'personal' },
  '/order-claim': { section: 'personal', module: 'order_claim' },
  ...
  '/subscription-codes': { section: 'admin', module: 'subscription_code' },
  '/code-center': { section: 'admin', module: 'code_center' },
  '/code-publication': { section: 'admin', module: 'code_publication' },
  '/order-claim-admin': { section: 'admin', module: 'order_claim_admin' },
