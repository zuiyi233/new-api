	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/redeem-code", middleware.CriticalRateLimit(), controller.RedeemCode)
				...
				selfRoute.POST("/lottery/play/:type", middleware.TurnstileCheck(), controller.DoLotteryPlay)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/:id/entitlements", controller.GetUserEntitlementsByAdmin)
				adminRoute.POST("/:id/entitlements", controller.AddUserEntitlementByAdmin)
				adminRoute.PUT("/:id/entitlements", controller.UpdateUserEntitlementByAdmin)
		...
		redemptionRoute.Use(middleware.AdminAuth())
		{
			...
			redemptionRoute.GET("/batches", controller.GetRedemptionBatchSummaries)
			redemptionRoute.GET("/:id", controller.GetRedemption)
			redemptionRoute.POST("/", controller.AddRedemption)
			redemptionRoute.POST("/import/preview", controller.PreviewRedemptionImport)
			redemptionRoute.POST("/import", controller.ImportRedemption)
			redemptionRoute.POST("/batch/delete", controller.DeleteRedemptionBatch)
			redemptionRoute.POST("/batch/status", controller.UpdateRedemptionBatchStatus)
			redemptionRoute.PUT("/", controller.UpdateRedemption)
			redemptionRoute.DELETE("/invalid", controller.DeleteInvalidRedemption)
			redemptionRoute.DELETE("/:id", controller.DeleteRedemption)
		}
		apiRouter.POST("/registration-code/validate", middleware.CriticalRateLimit(), controller.ValidateRegistrationCode)
		...
		registrationCodeRoute.Use(middleware.AdminAuth())
		{
			...
			registrationCodeRoute.GET("/batches", controller.GetRegistrationCodeBatchSummaries)
			registrationCodeRoute.GET("/usage", controller.GetRegistrationCodeUsages)
			registrationCodeRoute.GET("/:id", controller.GetRegistrationCode)
			registrationCodeRoute.POST("/", controller.AddRegistrationCode)
			registrationCodeRoute.POST("/import/preview", controller.PreviewRegistrationCodeImport)
			registrationCodeRoute.POST("/import", controller.ImportRegistrationCode)
			registrationCodeRoute.POST("/batch/delete", controller.DeleteRegistrationCodeBatch)
			registrationCodeRoute.POST("/batch/status", controller.UpdateRegistrationCodeBatchStatus)
		...
		subscriptionCodeRoute := apiRouter.Group("/subscription-code")
		subscriptionCodeRoute.Use(middleware.AdminAuth())
		{
			...
			subscriptionCodeRoute.GET("/batches", controller.GetSubscriptionCodeBatchSummaries)
			subscriptionCodeRoute.GET("/usage", controller.GetSubscriptionCodeUsages)
			subscriptionCodeRoute.GET("/:id", controller.GetSubscriptionCode)
			subscriptionCodeRoute.POST("/", controller.AddSubscriptionCode)
			subscriptionCodeRoute.POST("/import/preview", controller.PreviewSubscriptionCodeImport)
			subscriptionCodeRoute.POST("/import", controller.ImportSubscriptionCode)
			subscriptionCodeRoute.POST("/batch/delete", controller.DeleteSubscriptionCodeBatch)
			subscriptionCodeRoute.POST("/batch/status", controller.UpdateSubscriptionCodeBatchStatus)
