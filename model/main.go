...
func migrateDB() error {
	...
	err := DB.AutoMigrate(
		...
		&EmailVerificationRegistrationBinding{},
		&SubscriptionCode{},
...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&EmailVerificationRegistrationBinding{}, "EmailVerificationRegistrationBinding"},
		{&SubscriptionCode{}, "SubscriptionCode"},
		{&SubscriptionCodeUsage{}, "SubscriptionCodeUsage"},
		{&OrderClaim{}, "OrderClaim"},
		{&CodePublication{}, "CodePublication"},
		{&CodeDelivery{}, "CodeDelivery"},
		{&CodeDeliveryOperationLog{}, "CodeDeliveryOperationLog"},
		{&CodeOperationLog{}, "CodeOperationLog"},
		{&UserProductEntitlement{}, "UserProductEntitlement"},
		{&UserConcurrencyGrant{}, "UserConcurrencyGrant"},
